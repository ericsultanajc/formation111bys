					...
					<tbody>
						<c:forEach items="${mesEvaluations}" var="eval">
							<tr>
								...
								<td><div class="btn-group btn-group-sm"><a class="btn btn-primary" href="edit?id=${eval.id}"><i class="fa fa-edit"></i></a><a class="btn btn-danger" href="delete?id=${eval.id}"><i class="fa fa-trash"></i></a></div></td>
							</tr>
						</c:forEach>
					</tbody>
				</table>
